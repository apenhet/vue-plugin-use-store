'use strict';Object.defineProperty(exports,'__esModule',{value:true});require('core-js/stable'),require('regenerator-runtime/runtime');var vueDemi=require('vue-demi');function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
  try {
...
function storeModuleState(store, name) {
  ...
  return vueDemi.toRefs(rootState[name]);
}
/**
...
function storeModuleGetters(store, name) {
  ...
  var _loop = function _loop(key) {
    ...
    tree[treeKey] = vueDemi.computed(function () {
...
}exports.registerStore=registerStore;exports.useModuleStore=useModuleStore;